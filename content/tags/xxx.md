...
在化学战剂检测方面，基于离子迁移谱、火焰光度检测、傅里叶变换红外光谱等技术的便携式光谱仪是当前多国部队列装的主要选择。例如，德国Bruker公司的RAID-M100采用离子迁移谱检测化学战剂和有毒工业化学品，该产品已列入德国国防部采购清单。日本防卫省2025年度采购了462台LCD4离子迁移谱检测器，用于日本陆上自卫队的化学战剂检测。上述装备能够完成战场化学战剂检测，但其体积、功耗仍难以满足单兵可穿戴检测需求。近年来，研究者开始采用金属氧化物MEMS气体传感器进行化学战剂检测。Meier等采用化学气相沉积方法，在MEMS微热板阵列上制备TiO₂和SnO₂敏感薄膜，实现了对真实塔崩、沙林和硫芥毒气的5～200 ppb检测[9]；Bigiani等利用Au/Mn₃O₄复合材料实现了对氮芥化学战剂模拟物的ppb级响应，同时研究了多种干扰物对检测精度的影响[10]；Tomchenko等进一步采用SnO₂、WO₃、In₂O₃、CuO和Y₂O₃五种纳米晶金属氧化物制备厚膜传感器阵列，并在在多种干扰背景气体下开展测试，验证了传感器对沙林、梭曼和硫芥毒气的选择性响应[44]；Xu等构建了由24个金属氧化物气体传感器集成的MEMS传感器组成的阵列，单个敏感单元尺寸约为0.9 mm×0.9 mm，平均功耗低于10 mW，测试了其对氢氰酸、沙林、梭曼、VX和硫芥五种化学战剂的响应，并采用PCA、支持向量机、K近邻和神经网络进行识别，其中神经网络测试准确率达到100%[50]。上述研究表明，使用金属氧化物传感器对化学战剂检测具有较大的潜力，但已有高性能结果较多是有限背景气体干扰条件下获得的。真实战场中的湿度波动、燃油与发动机尾气、烟雾以及防护装备内部高湿微环境，会引起基线漂移、竞争吸附和误报警，因此实验室“能够响应”尚不能直接等同于战场环境中的可靠识别。
...
[44] TOMCHENKO A A, HARMER G P, MARQUIS B T. Detection of chemical warfare agents using nanostructured metal oxide sensors[J]. Sensors and Actuators B: Chemical, 2005, 108(1-2): 41-55. DOI: 10.1016/j.snb.2004.11.059.
.
[50] XU M, HU X, ZHANG H, et al. Detection and pattern recognition of chemical warfare agents by MOS-based MEMS gas sensor array[J]. Sensors, 2025, 25(8): 2633. DOI: 10.3390/s25082633.